...
<head>
    <meta charset="utf-8">
    <title>Service Venue- Online Service Provider</title>
    ...
    <div id="layout">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+01796404740"><i class="fa fa-phone"></i> +880-1796404740</a></li>
                            <li><a href="mailto:contact@servicevenue.bd"><i class="fa fa-envelope"></i>
                                    contact@servicevenue.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+01796404740"><i class="fa fa-phone"></i>
                                    +880-1796404740</a></li>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                    <a href="/"><img src="{{ asset('images/SV_Logo.png') }}" class="rounded-circle:40%" ></a>
                    </li>
                   ...
                   <!-- <li> <a href="javascript:void(0);">Air Conditioners</a>
                    ...
                    <li> <a href="#">Electronics Service</a>
                        <ul class="drop-down one-column hover-fade">
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Jatrabari, Dhaka</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@service.bd">contact@service.bd</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+8801796404740">+8801796404740</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+8801796404740">+8801796404740</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2024 Service Venue. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
