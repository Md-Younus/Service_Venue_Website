                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                <h4>The Office</h4>
                                <address>
                                    <strong>Services Venue Online Service Provider.</strong><br>
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Jatrabari,
                                    Dhaka<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +880-1796404740
                                </address>
                                <address>
                                    <strong>Emails Address</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:contact@service.bd"> contact@service.bd</a><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:support@service.bd"> support@service.bd</a>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
